...
(function (t) {
    ...
    function c(e) {
        ...
        function o(i, n) {
            ...
            if (a) t.isFunction(a) ? (v(), a.call(S, T.clone(), C.clone(), e.timezone, function (t) {
                ...
                if (c) {
                    ...
                    var g = t.extend({}, d || {}), p = M(i.startParam, e.startParam), m = M(i.endParam, e.endParam),
        ...
        function b(i, n, r, o, s) {
            ...
            return t.each(i, function (t, i) {
                var c = i._allDay, h = i._start, u = i._end, f = null != r ? r : c, g = h.clone(),
                    p = !n && u ? u.clone() : null;
        ...
        var T, C, H = S.trigger, x = S.getView, R = S.reportEvents, P = S.getEventEnd, z = {events: []}, L = [z], G = 0,
            N = 0, Y = 0, A = [];
    ...
    }, Te = {en: {columnFormat: {week: "ddd M/D"}, dayPopoverFormat: "dddd, MMMM D"}}, Ce = {
    ...
    j.prototype = {
        isHidden: !0, options: null, el: null, documentMousedownProxy: null, margin: 10, show: function () {
            ...
            var e, i, n, r, o, s = this.options, l = this.el.offsetParent().offset(), a = this.el.outerWidth(),
                c = this.el.outerHeight(), d = t(window), h = y(this.el);
        ...
        view: null, cellHtml: "<td/>", rowHtml: function (t, e) {
            ...
            var n = this.view, r = this.getHtmlRenderer("intro", e)(i || 0),
                o = this.getHtmlRenderer("outro", e)(i || 0), s = n.opt("isRTL"), l = s ? o : r, a = s ? r : o;
        ...
        el: null, coordMap: null, cellDuration: null, render: function () {
            this.bindHandlers()
        }, destroy: function () {
            ...
            var e, i, n, r = this, o = this.view, s = o.opt("selectable"), l = null, a = new q(this.coordMap, {
                scroll: o.opt("dragScroll"), dragStart: function () {
                    o.unselect()
        ...
        mousedOverSeg: null, isDraggingSeg: !1, isResizingSeg: !1, renderEvents: function () {
            ...
            var e = this.view, i = t.source || {}, n = t.color, r = i.color, o = e.opt("eventColor"),
                ...
                a = t.textColor || i.textColor || e.opt("eventTextColor"), c = [];
        ...
        segs: null, rowStructs: null, renderEvents: function (e) {
            ...
            var i, n = this.view, r = n.opt("isRTL"), o = t.event, s = n.isEventDraggable(o),
                l = !e && o.allDay && t.isEnd && n.isEventResizable(o), a = this.getSegClasses(t, s, l),
                c = this.getEventSkinCss(o), d = "";
            ...
            var r, o, s, l, a, c, d, h = this.view, u = h.colCnt, f = this.buildSegLevels(i), g = Math.max(1, f.length),
                p = t("<tbody/>"), m = [], v = [], y = [];
            for (r = 0; g > r; r++) {
        ...
        segPopover: null, popoverSegs: null, destroySegPopover: function () {
            ...
            var r, o, s, l, a, c, d, h, u, f, g, p, m, v, y, w, E = this, b = this.view, S = this.rowStructs[e], D = [],
                T = 0;
            ...
            return t('<a class="fc-more"/>').text(this.getMoreLinkText(i.length)).on("click", function (o) {
                var s = r.opt("eventLimitClick"), l = r.cellToDate(e), a = t(this), c = n.getCellDayEl(e),
                    d = n.getCellSegs(e), h = n.resliceDaySegs(d, l), u = n.resliceDaySegs(i, l);
            ...
            var n, r = this.view, o = r.opt("theme"), s = e.format(r.opt("dayPopoverFormat")),
        ...
        segs: null, eventSkeletonEl: null, renderEvents: function (e) {
            ...
            var i, n, r, o = this.view, s = t.event, l = o.isEventDraggable(s),
                a = !e && t.isEnd && o.isEventResizable(s), c = this.getSegClasses(t, l, a),
            ...
            var e, i, n = this.view, r = n.opt("isRTL"), o = n.opt("slotEventOverlap"), s = t.backwardCoord,
                l = t.forwardCoord, a = this.generateSegVerticalCss(t);
        ...
        name: "month", incrementDate: function (t, e) {
