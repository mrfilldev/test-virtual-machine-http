...
(function (t) {
    ...
    t.ui = t.ui || {}, t.extend(t.ui, {
        ...
        scrollParent: function (e) {
            var n = this.css("position"), i = "absolute" === n, r = e ? /(auto|scroll|hidden)/ : /(auto|scroll)/,
...
(function (t) {
    ...
    return t.cleanData = function (e) {
        ...
        }), o.prototype = t.widget.extend(a, {widgetEventPrefix: r ? a.widgetEventPrefix || e : e}, u, {
            constructor: o,
            namespace: d,
            widgetName: e,
            widgetFullName: s
...
(function (t) {
    ...
    return t.widget("ui.draggable", t.ui.mouse, {
        ...
        start: function (e, i, s) {
            ...
            var n, o, r, a, l, h, c, p, u, d, f = s.options, g = f.snapTolerance, m = i.offset.left,
            ...
            }).left - s.margins.left)), !s.snapElements[u].snapping && (n || o || r || a || d) && s.options.snap.snap && s.options.snap.snap.call(s.element, e, t.extend(s._uiHash(), {snapItem: s.snapElements[u].item})), s.snapElements[u].snapping = n || o || r || a || d)
        }
