...
(function (a) {
    ...
    function k(a) {
        var b = x(a), c = b.year || 0, d = b.quarter || 0, e = b.month || 0, f = b.week || 0, g = b.day || 0,
    ...
    function P(a) {
        a = a || "";
        var b = a.match(Sb) || [], c = b[b.length - 1] || [], d = (c + "").match(ec) || ["-", 0, 0],
            e = +(60 * d[1]) + z(d[2]);
        return "+" === d[0] ? -e : e
    }
    ...
    function eb(a, b, c) {
        var d = rb.duration(a).abs(), e = wb(d.as("s")), f = wb(d.as("m")), g = wb(d.as("h")), h = wb(d.as("d")),
            i = wb(d.as("M")), j = wb(d.as("y")),
    ...
    rb.normalizeUnits = function (a) {
        ...
        calendar: function (a) {
            var b = a || rb(), c = J(b, this).startOf("day"), d = this.diff(c, "days", !0),
