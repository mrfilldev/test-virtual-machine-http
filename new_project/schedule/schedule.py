...
@schedule_bp.route('/get_order_basket/<string:carwash_id>&<string:order_id>', methods=['GET'])
def get_order_basket(carwash_id, order_id):
    return backend_get_order_basket(request, carwash_id, order_id)
