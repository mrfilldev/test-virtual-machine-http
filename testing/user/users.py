...
from .backend import list_workers
...
@carwash_bp.route('/prices_status/<string:carwash_id>', methods=['POST', 'GET'])
def prices_status(carwash_id):
    return change_price_status(request, carwash_id)
